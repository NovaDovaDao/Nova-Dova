      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
        ...
        >
          ...
          <div className="relative mb-8">
            <h1 className="text-6xl md:text-8xl font-bold text-transparent 
                        bg-clip-text bg-gradient-to-r from-space-blue to-space-purple 
                        animate-neon-glow tracking-tight">
              Coming Soon
            </h1>
            <div className="absolute -inset-1 bg-gradient-to-r from-space-blue to-space-purple 
          ...
          <div className="mt-8 mb-12">
            ...
            <a 
              ...
              className="text-space-purple font-mono bg-gray-900/30 backdrop-blur-sm 
                       p-4 rounded-lg inline-block border border-gray-800
                       hover:border-space-purple transition-all duration-300
                       hover:scale-105"
            >
              8HjiRvPNwFT9jpzAAsYF4rE9y576CKdTkQZXaxibpump
            </a>
          </div>
